...
# MODEL_PATH = os.environ.get('MODEL_PATH', '/home/chendz/llm/chatglm_finetune_demo/output/checkpoint-3000')
...
model, tokenizer =load_model_and_tokenizer("/home/chendz/llm/chatglm_finetune_demo/output/checkpoint-3000",trust_remote_code=True)
# model, tokenizer =load_model_and_tokenizer('/home/chendz/llm/model/chatglm3-6b',trust_remote_code=True)
